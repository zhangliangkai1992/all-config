...
awful.screen.connect_for_each_screen(function(s)
	...
	local names = {"main", "emacs", "chrome", "terminal", "office", "amuse", "vbox", "others"}
	local l = awful.layout.suit
	local layouts = {l.floating, l.tile, l.tile, l.tile, l.floating, l.tile, l.max, l.floating}
...
globalkeys = gears.table.join(
	...
	-- zlk-binding
		...
		awful.key({ modkey },"y",
				...
				{description = "eclipse",  group = "launcher"}),
		awful.key({ }, "F11", awesome.restart,
              {description = "reload awesome", group = "awesome"}),
